...
public class TestMailJob extends QuartzJobBean {
	...
	public void fetch(String pop3Host, String storeType, String user,
		...
		try {
			...
			if (isAttachmentPresent) {
				System.out
						.println("Attachment is present ...so go for operation");
			} else {
				System.out
						.println("Attachment is not present ...return template ");
			}
	 ...
	 */
	public static void writePart(Part p, boolean isAttachmentPresent)
			throws Exception {
